...
import com.maudev.springboot.app.models.service.JpaUserDetailService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * USANDO JDBC
	 * 
	 * @Autowired public void congurerGlobal(AuthenticationManagerBuilder build)
	 * throws Exception { build.jdbcAuthentication() .dataSource(dataSource)
	 ...
	 * 
	 * @Autowired public void congurerGlobal(AuthenticationManagerBuilder builer)
	 * throws Exception { puede aparecer en otras versiones UserBuilder users =
	 * User.withDefaultPasswordEncoder(); PasswordEncoder encoder =
	 * this.passwordEncoder; // UserBuilder users =
	 * User.builder().passwordEncoder(password -> // encoder.encode(password)); //
	 * mas simple lambda java 8 UserBuilder users =
	 * User.builder().passwordEncoder(encoder::encode); //Creamos los usuarios
